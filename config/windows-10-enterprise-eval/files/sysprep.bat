...
RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 e:\vioserial\w10\amd64\vioser.inf
RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 e:\vioscsi\w10\amd64\vioscsi.inf
RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 e:\balloon\w10\amd64\balloon.inf
pnputil -i -a e:\vioserial\w10\amd64\vioser.inf
pnputil -i -a e:\vioscsi\w10\amd64\vioscsi.inf
pnputil -i -a e:\balloon\w10\amd64\balloon.inf

mkdir "C:\Program Files\Virt"
copy /Y "e:\balloon\w10\amd64\blnsvr.exe" "C:\Program Files\Virt"
